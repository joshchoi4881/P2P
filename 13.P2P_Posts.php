...
#navbartwo {
	...
	<body style="background-color: #4682B4">
		...
		<div id="wrapper">
			<div class="tasks">
				<?php
					echo "<center><h1 id='tasksTitle'>Posts</h1></center>";
					echo "<form action='13.P2P_Posts.php?usernameLogin=".$usernameLogin."' method='POST'>
			...
			<img id="image" src="" height="250" width="200" alt=" <?php echo $firstName; echo " "; echo $lastName; ?> 's Profile Picture" title=" <?php echo $firstName; echo " "; echo $lastName; ?> 's Profile Picture"/>
			<br>
