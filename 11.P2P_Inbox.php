	...
	<body style="background-color: #4682B4">
		...
		<div id="wrapper">
			...
			if ($_GET['usernameLogin'] == $loggedInUserId) {
				...
				echo '<br><br>
					<a href="18.P2P_Send_Messages.php?usernameLogin='.$loggedInUserId.'&receiver=">Send Messages</a>';
				echo '<br><br>
					<a href="19.P2P_Your_Messages.php?usernameLogin='.$loggedInUserId.'">Your Messages</a>';
			}
				?>
			</div>
